...
export async function installSelfVerifySkill(
  p: SelfVerifyPaths,
): Promise<void> {
...
export async function uninstallSelfVerifySkill(
  p: SelfVerifyPaths,
): Promise<void> {
  let existing: string;
  try {
...
export async function isSelfVerifySkillInstalled(
  p: SelfVerifyPaths,
): Promise<boolean> {
  try {
