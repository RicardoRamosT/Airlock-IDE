...
read them alongside your terminal work. Keep Files visible unless the human is doing
something where the tree is pure noise (a rare case). There is no project signal that makes
Files irrelevant — treat it as the default-on, baseline section.
